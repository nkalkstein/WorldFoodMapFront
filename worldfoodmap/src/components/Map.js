...
class Map extends Component {
  constructor() {
    ...
    this.state = {
      ...
      cities: [
        ...
        { name: "Bismarck", country:"Kyrgyzstan", coordinates: [-100.47, 46.49] },
        ...
        { name: "Chiang Mai", country:"USA", coordinates: [99.00, 18.48] },
  ...
  render() {
   ...
   if (!this.state.city){
    return (
      <div>
      <h2> Click a City Button or a Marker on the Map to Explore the World's Cuisine</h2>
      ...
      <div>
        ...
        <div style={wrapperStyles}>
          <ComposableMap
              ...
              <Markers>
                {
                 ...
                 this.state.cities.map((city, i) => (
                    <Marker name={city.name} onClick={this.handleMarkerSelection} data-city={i} marker={city}>
           ...
           <h3> Click another Marker on the Map or Reset to the World Map </h3>
          <br></br>
        </div>
        <GMap coordinates={this.state.city.coordinates}/>
      </div>
    )
}
